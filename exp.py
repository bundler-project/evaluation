...
def remote_script(outdir, qdisc, alg, conns, samplerate):
...
def local_script(outdir, conns, samplerate):
...
remote_script(args.outdir, args.qdisc, algs[args.alg], args.conns, args.samplerate)
local_script(args.outdir, args.conns, args.samplerate)
